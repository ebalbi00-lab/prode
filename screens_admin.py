...
from db import (
    ...
    leer_comprobante, db_generar_backup, db_restaurar_backup,
)
...
def _tab_resumen(panel_consumo=False):
    ...
    nuevo_estado = st.toggle("📋 Registro abierto", value=registro_abierto)
...
def _tab_exportar():
    ...
    st.caption("Descargá backups manuales completos o por fase y restaurá un JSON exportado desde este panel.")
